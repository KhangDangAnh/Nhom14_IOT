...
@Composable
public fun LivingRoom(navController: NavHostController) {
    Scaffold(
        topBar = {
            TopAppBar(
                colors = TopAppBarDefaults.largeTopAppBarColors(containerColor = Color(12, 27, 50), titleContentColor = Color.White),
                title = {
                    Text(text = "Phòng Khách",fontWeight = FontWeight.Bold, modifier = Modifier.fillMaxWidth(), textAlign = TextAlign.Center)
                },
        ...
        Column(modifier = Modifier
            ...
            NewLightCardByButton("LED_Khach")
        }
    }
}